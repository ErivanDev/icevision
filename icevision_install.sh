...
case ${target} in 
   cuda10)  
      ...
      pip install torch==1.11.0+cu102 torchvision==0.12.0+cu102 torchtext==0.12.0 -f https://download.pytorch.org/whl/torch_stable.html --upgrade -q
   ...
   cuda11)  
      echo "Installing icevision + dependencices for ${1}"
      echo "- Installing torch and its dependencies"
      pip install torch==1.11.0+cu102 torchvision==0.12.0+cu102 torchtext==0.12.0 -f https://download.pytorch.org/whl/torch_stable.html --upgrade 
   ...
   cpu)  
      echo "Installing icevision + dependencices for ${1}"
      echo "- Installing torch and its dependencies"
      pip install torch=="1.11.0+cpu" torchvision=="0.11.1+cpu" torchtext==0.11.0 -f https://download.pytorch.org/whl/torch_stable.html  
